...
<div id="schedule">
    <ul>
        ...
        <li>
            9:00-9:30 - Invited talk: [Philipp Cimiano](http://www.sc.cit-ec.uni-bielefeld.de/team/philipp-cimiano/) -- <b>Knowledge graphs for information extraction</b> <button class="btn btn-outline-info btn-xs" type="button" data-toggle="collapse" data-target="#philipp-card" aria-expanded="false" aria-controls="philipp-card">Abstract</button>
        ...
        <li>
            9:30-10:00 - Invited talk: [Will Hamilton](https://williamleif.github.io/) -- <b>Meta Learning and Logical Induction on Knowledge Graphs</b> <button class="btn btn-outline-info btn-xs" type="button" data-toggle="collapse" data-target="#will-card" aria-expanded="false" aria-controls="will-card">Abstract</button>
        ...
        <li>
            10:45-11:15 - Invited talk: [Fabio Petroni](https://www.fabiopetroni.com/) -- <b>Title TODO</b> <button class="btn btn-outline-info btn-xs" type="button" data-toggle="collapse" data-target="#fabio-card" aria-expanded="false" aria-controls="fabio-card">Abstract</button>
            <div class="collapse" id="fabio-card"><div class="card card-body">Abstract TODO</div></div>
        </li>
        <li>
            11:15-11:45 - Invited talk: [Colin Raffel](https://craffel.github.io/) -- <b>Answering Questions by Querying the Implicit Knowledge Base Inside T5</b> <button class="btn btn-outline-info btn-xs" type="button" data-toggle="collapse" data-target="#colin-card" aria-expanded="false" aria-controls="colin-card">Abstract</button>
